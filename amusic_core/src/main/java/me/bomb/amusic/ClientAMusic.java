	...
	public boolean playSoundUntrackable(UUID playeruuid, String name, double x, double y, double z, float volume, float pitch) {
		...
		Runnable r = new Runnable() {
			public void run() {
				...
				long lb;
				lb = playeruuid.getMostSignificantBits();
				byte[] buf = new byte[0x30 + namelength];
				buf[0x00] = (byte) lb;
				lb>>>=8;
				buf[0x01] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x07] = (byte) lb;
				lb = playeruuid.getLeastSignificantBits();
				buf[0x08] = (byte) lb;
				lb>>>=8;
				buf[0x09] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x0F] = (byte) lb;
				lb = Double.doubleToRawLongBits(x);
				buf[0x10] = (byte) lb;
				lb>>>=8;
				buf[0x11] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x17] = (byte) lb;
				lb = Double.doubleToRawLongBits(y);
				buf[0x18] = (byte) lb;
				lb>>>=8;
				buf[0x19] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x1F] = (byte) lb;
				lb = Double.doubleToRawLongBits(z);
				buf[0x20] = (byte) lb;
				lb>>>=8;
				buf[0x21] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x27] = (byte) lb;
				lb = Float.floatToRawIntBits(volume);
				buf[0x28] = (byte) lb;
				lb>>>=8;
				buf[0x29] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x2B] = (byte) lb;
				lb = Float.floatToRawIntBits(pitch);
				buf[0x2C] = (byte) lb;
				lb>>>=8;
				buf[0x2D] = (byte) lb;
				lb>>>=8;
				...
				lb>>>=8;
				buf[0x2F] = (byte) lb;
				System.arraycopy(nameb, 0, buf, 0x30, namelength);
