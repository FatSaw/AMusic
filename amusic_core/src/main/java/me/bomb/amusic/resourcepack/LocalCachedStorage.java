...
public class LocalCachedStorage extends me.bomb.amusic.resourcepack.Data {
	...
	protected LocalCachedStorage(boolean lockwrite, LocalSoundSource lczs, PackMergeSource pms, Path packeddirectory) {
		super(lockwrite);
		this.lczs = lczs;
		this.pms = pms;
