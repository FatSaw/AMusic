...
public final class SSLPageSender extends Thread {
	...
	private final SSLSocket connected;
	...
	protected SSLPageSender(UploadManager uploadmanager, SSLSocket connected) {
