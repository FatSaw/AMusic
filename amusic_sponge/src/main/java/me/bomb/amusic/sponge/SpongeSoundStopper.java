...
public final class SpongeSoundStopper implements SoundStopper {
	...
	public void stopSound(UUID uuid, UUID soundhash, short id, byte partid) {
		...
		final String musicid = new StringBuilder("minecraft:amusic.internal.").append(soundhash.toString()).append(HexUtils.shortToHex(id)).append(HexUtils.byteToHex(partid)).toString();
